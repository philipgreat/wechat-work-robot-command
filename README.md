...
chmod +x webchatworkrobot-linux



直接发送内容
```
./wechatworkrobot-linux -robotkey <your-robot-key> -content content
```

或者使用文件内容
```
./wechatworkrobot-linux -robotkey <your-robot-key> -content @file
```
...
linux:
	GOOS=linux GOARCH=amd64 go build -o wechatworkrobot-linux src/main.go 
